...
export interface ApiAppointmentAppointment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    idSick: Schema.Attribute.String;
...
export interface ApiClincClinc extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::clinc.clinc'> &
      Schema.Attribute.Private;
  };
}
...
export interface ApiDoctorDoctor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    expertise: Schema.Attribute.Integer;
    time: Schema.Attribute.Time;
    ...
    appointments: Schema.Attribute.Relation<
      ...
      'api::appointment.appointment'
    >;
    clincs: Schema.Attribute.Relation<'manyToMany', 'api::clinc.clinc'>;
    reviews: Schema.Attribute.Relation<'oneToMany', 'api::review.review'>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiHospitalHospital extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    emergency: Schema.Attribute.Boolean;
    startVisit: Schema.Attribute.Time;
    endVisit: Schema.Attribute.Time;
    clincs: Schema.Attribute.Relation<'oneToMany', 'api::clinc.clinc'>;
    doctors: Schema.Attribute.Relation<'manyToMany', 'api::doctor.doctor'>;
    reviews: Schema.Attribute.Relation<'oneToMany', 'api::review.review'>;
    appointments: Schema.Attribute.Relation<
      'oneToMany',
